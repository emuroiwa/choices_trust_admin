...
return true;
	...
	return false;
  	...
  	function SetSales($user,$ordertype,$region,$ordernumber,$platform,$transactiontype){
		  $query = mysql_query("INSERT INTO `booksales` (`user`, `ordertype`, `region`, `transactiondate`,`ordernumber`,`status`,`platform`,`transactiontype`) VALUES ('$user', '$ordertype', '$region', NOW(),'$ordernumber','pending','$platform','$transactiontype')");
