...
} $rs = mysql_query("insert into users(name,surname,cellnumber,email,address,username,password,idnumber,status,date,access,department,suspend,emailstatus,fastatus) values ('$name','$_POST[surname]','$contact','$email','$address','$email','$pwd','$_POST[type]','1',now(),'2','Facilitator','1','Y','N')") ;
