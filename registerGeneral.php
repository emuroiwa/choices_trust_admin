...
if(substr($_POST['contact'],0, 1)==0){
 ...
 $rs = mysql_query("insert into users(name,surname,cellnumber,email,address,username,password,idnumber,status,date,access,department,suspend,emailstatus,fastatus) values ('$name','$_POST[surname]','$contact','$email','$address','$email','$pwd','$_POST[type]','1',now(),'2','General','1','Y','Y')") ;
 $msg="Thank you <strong>".$name."</strong>. You are now part of Choices Trust. ";
  SendEmail("Choices Trust","New User","Choices Trust New User",$msg,$email)
