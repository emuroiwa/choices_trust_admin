...
if(substr($_POST['contact'],0, 1)==0){
   ...
   // echo "insert into users(name,surname,cellnumber,email,address,username,password,idnumber,status,date,access,department,suspend,emailstatus,fastatus,logo) values ('$_POST[name]','$_POST[surname]','$_POST[cellnumber]','$_POST[email]','$_POST[address]','$_POST[email]','$pwd','$_POST[type]','1',now(),'2','Facilitator','1','Y','N','$fn')";
 $rs = mysql_query("insert into users(name,surname,cellnumber,email,address,username,password,idnumber,status,date,access,department,suspend,emailstatus,fastatus,logo) values ('$name','$_POST[surname]','$contact','$email','$address','$email','$pwd','$_POST[type]','1',now(),'2','Partner','1','Y','Y','$fn')") ;
 ...
 You Applications is being verified by Choices Trust. ";
   SendEmail("Choices Trust","New Partner","Choices Trust New Partner",$msg,$email);
...
<option data-countryCode="ZM" value="255">Tanzania (+255)</option>
...
<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
       ...
       <div class="form-group has-feedback"><input type="number" class="form-control" placeholder="Cellphone eg 774002797" name="contact" required>
          </div>
          <!--  <div class="form-group has-feedback">
