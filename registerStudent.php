...
if(substr($_POST['contact'],0, 1)==0){
 ...
 $rs = mysql_query("insert into users(name,surname,cellnumber,email,address,username,password,idnumber,status,date,access,department,suspend,emailstatus,fastatus) values ('$name','$_POST[surname]','$contact','$email','$address','$email','$pwd','$_POST[type]','1',now(),'2','Student','1','Y','Y')") ;
 $msg="Thank you <strong>".$_POST['name']."</strong>. You Applications is being verified by Choices Trust. ";
   SendEmail("Choices Trust","New Student","Choices Trust New Student",$msg,$email);
