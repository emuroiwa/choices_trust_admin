...
define('site_url', 'http://www.choicestrust.com/admin/scripts/Checkout');
...
$integration_id ='2827';
$integration_key = '7c4d97be-5399-44ab-8c48-23f5d1b64b8b'; //oops this MUST BE SECRET, take it from a Database, encrypted or something
$authemail = '';
$initiate_transaction_url = 'https://www.paynow.co.zw/Interface/InitiateTransaction';
$orders_data_file = 'ordersdata.ini';
$checkout_url = site_url.'http://localhost:8099/choicessite/admin/scripts/Checkout/paynow.php';
...
UpdateSales($idxx,Breakdown($content1));
	...
	//Thank	your customer
	getBackFromPaynowHTML(Breakdown($content1));
}
...
//ernest  saving to datatbase
		SetSales($_SESSION['username'],$_SESSION['price'],UserRegion(),$local_order_id,'Paynow',$_SESSION['booktype'],$_SESSION['transactiontype']);
...
<form name="frmSellingMilk" action="?action=createtransaction" method="post">
			<span>Choices Book  (Just $<?php echo $_SESSION['price'] ;?>)</span>
