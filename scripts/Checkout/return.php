...
//ernest  saving to datatbase
		SetSales($user,$amt,UserRegion(),$transactionId,'Paypal',$transactiontypevariable);
		...
		?>
    		...
    		<span class="span5">
    			...
    			<?php if($transactiontypevariable!="Donate"){
header("location: invoice.php?id=$transactionId");
    				?>
    			<h3> Click <a href='invoice.php?id=<?php echo $transactionId; ?>'>here </a> to return to Home Page</h3>
    			    			<?php }else{
header("location: invoiceprint.php?id=$transactionId");

    			    				?>
    			<h3> Click <a href='invoiceprint.php?id=<?php echo $transactionId; ?>'>here </a> to return to Home Page</h3>
