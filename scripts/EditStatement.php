...
<?php
	$rs=mysql_query("select * from  statements ") or die(mysql_error());	
 if(mysql_num_rows($rs)==0){echo "No results";}
?>

<center><p><strong><h4>List Of Statements</h4></strong></p></center>
<div class="table-responsive">
  <table class="table table-striped table-bordered table-hover" id="dataTables-example" width="100%" border="1">
    ...
    <td><?php echo "<a href='index.php?page=deletestatements.php&id=$row[sid]' onclick='return confirm(\"Are you sure?\")'>[click to delete]</a></font>";?></td>
