...
//-->
					 ...
					 <center> <table width="50%" border="0"  align="center" class="table table-bordered table-hover">
    
    <tr><td colspan="2"><div align="center"><strong><em>Change Password</em></strong></div></td>
    </tr>
      <tr>
        <td width="277"><table width="100%" align="center" border="0" bgcolor="#FFFFFF" style="border-top:3px solid #000000;" class="table table-bordered table-hover">
		<tr>
