...
// Set up chart
//$Chart = &$Table->Sales_Chart;
// Initialize chart data

$Chart->ID = "Sales_Sales_Chart"; // Chart ID
...
<?php
	...
	if ($Chart->ShowChart) { // Show actual chart
		...
		$TmpChartImage = ewr_TmpChartImage("chart_Sales_Sales_Chart", FALSE);
		$TmpGridImage = ewr_TmpChartImage("chart_Sales_Sales_Chart_grid", FALSE);
		if ($TmpChartImage <> "") {
?>
