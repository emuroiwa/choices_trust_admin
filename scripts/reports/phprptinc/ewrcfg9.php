...
define("EWR_PROJECT_ID", "{502C7FE7-7939-4DA2-B926-2E1B54AA4C6C}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "choices", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "choicesroot", "pass" => "choicestrust", "db" => "choicestrust", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'adk18MRF30YbaG9D', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/choices.css", TRUE); // Project stylesheet file name
